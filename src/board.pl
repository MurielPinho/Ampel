...
/* Prints the interface for the main menu */
...
/* Prints interface for user to choose dificulty */
printDifficulty :-
    border('t',TopBorder),
    border('b',BotBorder),
    border('v',VertBorder),
...
/* Return the ASCII art for the title */
...
/*Returns the number indicator and spaces for the left of the board*/
...
/* Returns the borders for the user interface*/
