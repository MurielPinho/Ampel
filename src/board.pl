...
[empty,empty,empty,yellow,green,empty,empty,blank,blank,blank,blank],
...
[yellow,empty,empty,empty,empty,empty,empty,empty,empty,empty,empty]],[2,2],[green,20],[red,20]]).
